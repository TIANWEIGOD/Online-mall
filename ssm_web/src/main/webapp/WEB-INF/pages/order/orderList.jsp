        ...
        <section class="content"> <!-- .box-body -->
            <div class="box box-primary">
                ...
                <div class="box-footer">
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            总共${page.pages}页，共${page.pageSize} 条数据。 每页
                    ...
                    <script type="text/javascript">
                        function submitPageSize(who) {
                            location.href = "${pageContext.request.contextPath}/order/findAllOrder?pageNum=1&pageSize=" + who.value;
                        }
                    </script>
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            <li>
                                <a href="${pageContext.request.contextPath}/order/findAllOrder?pageNum=${page.firstPage}&pageSize=${page.pageSize}"
                                   aria-label="Previous">首页</a></li>
                            <li>
                                <c:if test="${page.hasPreviousPage}">
                                    <a href="${pageContext.request.contextPath}/order/findAllOrder?pageNum=${page.prePage}&pageSize=${page.pageSize}">上一页</a>
                                </c:if>
                                <c:if test="${!page.hasPreviousPage}">
                                    <a href="${pageContext.request.contextPath}/order/findAllOrder?pageNum=${page.firstPage}&pageSize=${page.pageSize}">上一页</a>
                                </c:if>
                            </li>
                            <c:forEach items="${page.navigatepageNums}" var="n">
                                <li>
                                    <a href="${pageContext.request.contextPath}/order/findAllOrder?pageNum=${n}&pageSize=${page.pageSize}">${n}</a>
                                </li>
                            </c:forEach>
                            <li>
                                <c:if test="${page.hasNextPage}">
                                    <a href="${pageContext.request.contextPath}/order/findAllOrder?pageNum=${page.nextPage}&pageSize=${page.pageSize}">下一页</a>
                                </c:if>
                                <c:if test="${!page.hasNextPage}">
                                    <a href="${pageContext.request.contextPath}/order/findAllOrder?pageNum=${page.lastPage}&pageSize=${page.pageSize}">下一页</a>
                                </c:if>
                            </li>
                            <li>
                                <a href="${pageContext.request.contextPath}/order/findAllOrder?pageNum=${page.lastPage}&pageSize=${page.pageSize}"
